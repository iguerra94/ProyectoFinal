...
public class ViajeCabeceraOfferNotFoundException extends Exception {
	
//	private static final long serialVersionUID = -3038320082924640966L;

	/**
	 * Instancia un nuevo objeto de la Excepcion <code>ViajeCabeceraOfferNotFoundException</code>
	 */
	
	public ViajeCabeceraOfferNotFoundException(){
