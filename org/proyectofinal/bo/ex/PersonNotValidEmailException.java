...
public class PersonNotValidEmailException extends Exception {
	
//	private static final long serialVersionUID = -5431279917975862341L;

	/**
	 * Instancia un nuevo objeto de la Excepcion <code>PersonNotValidEmailException</code>
	 */
	
	public PersonNotValidEmailException(){
