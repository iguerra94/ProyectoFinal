...
public class ViajeCabeceraNotFoundParametersException extends Exception {
	
//	private static final long serialVersionUID = -5431279917975862341L;

	/**
	 * Instancia un nuevo objeto de la Excepcion <code>ViajeCabeceraNotFoundParametersException</code>
	 */
	
	public ViajeCabeceraNotFoundParametersException(){
