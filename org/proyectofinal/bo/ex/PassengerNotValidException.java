...
public class PassengerNotValidException extends Exception {

//	private static final long serialVersionUID = 8712190458163669657L;
	
	/**
	 * Instancia un nuevo objeto de la Excepcion <code>PassengerNotValidException</code>
	 */
	
	public PassengerNotValidException(){
