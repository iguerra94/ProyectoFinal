...
//		pasajeros = new ArrayList<List<Object>>();
		...
		lblAsientosDisp.setBounds(125, 10, 33, 38);
		...
		lblCantidadDeAsientos.setBounds(-5, 12, 144, 37);
		...
		final Boton btnNro1 = new Boton("1", 180f);			
		...
		final Boton btnNro2 = new Boton("2", 180f);		
		...
		final Boton btnNro7 = new Boton("7", 180f);
		...
		final Boton btnNro8 = new Boton("8", 180f);
		...
		final Boton btnNro13 = new Boton("13", 180f);
		...
		final Boton btnNro14 = new Boton("14", 180f);
		...
		final Boton btnNro3 = new Boton("3", 180f);
		...
		final Boton btnNro4 = new Boton("4", 180f);
		...
		final Boton btnNro9 = new Boton("9", 180f);
		...
		final Boton btnNro10 = new Boton("10", 180f);
		...
		final Boton btnNro15 = new Boton("15", 180f);
		...
		final Boton btnNro16 = new Boton("16", 180f);
		...
		final Boton btnNro5 = new Boton("5", 180f);
		...
		final Boton btnNro6 = new Boton("6", 180f);
		...
		final Boton btnNro11 = new Boton("11", 180f);
		...
		final Boton btnNro12 = new Boton("12", 180f);
		...
		final Boton btnNro17 = new Boton("17", 180f);
		...
		final Boton btnNro18 = new Boton("18", 180f);
		...
		final Boton btnNro19 = new Boton("19", 90f);
		...
		final Boton btnNro20 = new Boton("20", 90f);
		...
		final Boton btnNro25 = new Boton("25", 90f);
		...
		final Boton btnNro26 = new Boton("26", 90f);
		...
		final Boton btnNro31 = new Boton("31", 90f);
		...
		final Boton btnNro32 = new Boton("32", 90f);
		...
		final Boton btnNro37 = new Boton("37", 90f);
		...
		final Boton btnNro38 = new Boton("38", 90f);
		...
		final Boton btnNro43 = new Boton("43", 90f);
		...
		final Boton btnNro44 = new Boton("44", 90f);
		...
		final Boton btnNro49 = new Boton("49", 90f);
		...
		final Boton btnNro50 = new Boton("50", 90f);
		...
		final Boton btnNro55 = new Boton("55", 90f);
		...
		final Boton btnNro56 = new Boton("56", 90f);
		...
		final Boton btnNro61 = new Boton("61", 90f);
		...
		final Boton btnNro62 = new Boton("62", 90f);
		...
		final Boton btnNro21 = new Boton("21", 90f);
		...
		final Boton btnNro22 = new Boton("22", 90f);
		...
		final Boton btnNro27 = new Boton("27", 90f);
		...
		final Boton btnNro28 = new Boton("28", 90f);
		...
		final Boton btnNro33 = new Boton("33", 90f);
		...
		final Boton btnNro34 = new Boton("34", 90f);
		...
		final Boton btnNro39 = new Boton("39", 90f);
		...
		final Boton btnNro40 = new Boton("40", 90f);
		...
		final Boton btnNro45 = new Boton("45", 90f);
		...
		final Boton btnNro46 = new Boton("46", 90f);
		...
		final Boton btnNro51 = new Boton("51", 90f);
		...
		final Boton btnNro52 = new Boton("52", 90f);
		...
		final Boton btnNro57 = new Boton("57", 90f);
		...
		final Boton btnNro58 = new Boton("58", 90f);
		...
		final Boton btnNro63 = new Boton("63", 90f);
		...
		final Boton btnNro64 = new Boton("64", 90f);
		...
		final Boton btnNro23 = new Boton("23", 90f);
		...
		final Boton btnNro24 = new Boton("24", 90f);
		...
		final Boton btnNro29 = new Boton("29", 90f);
		...
		final Boton btnNro30 = new Boton("30", 90f);
		...
		final Boton btnNro35 = new Boton("35", 90f);
		...
		final Boton btnNro36 = new Boton("36", 90f);
		...
		final Boton btnNro41 = new Boton("41", 90f);
		...
		final Boton btnNro42 = new Boton("42", 90f);
		...
		final Boton btnNro47 = new Boton("47", 90f);
		...
		final Boton btnNro48 = new Boton("48", 90f);
		...
		final Boton btnNro53 = new Boton("53", 90f);
		...
		final Boton btnNro54 = new Boton("54", 90f);
		...
		final Boton btnNro59 = new Boton("59", 90f);
		...
		final Boton btnNro60 = new Boton("60", 90f);
		...
		final Boton btnNro65 = new Boton("65", 90f);
		...
		final Boton btnNro66 = new Boton("66", 90f);
...
//		}
	...
	public void mouseReleased(MouseEvent e) {
		...
		if (cmbCantPasajeros.getSelectedIndex() > 0 && b.getEstado() == true){
